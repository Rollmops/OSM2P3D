...
class FileObject(object):
    ...
    @staticmethod
    def get(filename):
        if FileObject._instance is None:
            with open(filename, "r+b") as f:
                FileObject._instance = mmap.mmap(f.fileno(), 0)
        return FileObject._instance
...
class PBFFile(object):
    ...
    def __init__(self, filename):
        ...
        self.file = FileObject.get(filename)
